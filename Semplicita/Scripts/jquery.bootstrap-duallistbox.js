...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: 'remove filter',
      filterPlaceHolder: 'Find User by Name...',
  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('fas fa-arrow-right').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('fas fa-arrow-left').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i, .move > i').removeClass().addClass('fas fa-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass().addClass('fas fa-arrow-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
